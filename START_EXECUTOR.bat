...
kv['POLL_INTERVAL_S']='45'; kv['MIN_GOD_STACKED']='6'; kv['GAMMA_RAMP_POLL_ENABLED']='true'; kv['POSITION_MONITOR_ENABLED']='true'; kv['EXEC_BROKER']='robinhood'; kv['KILL_SWITCH']=kv.get('KILL_SWITCH') or 'false'; kv['ROBINHOOD_PAPER_MODE']=kv.get('ROBINHOOD_PAPER_MODE') or 'false';\
out=[]; seen=set();\
