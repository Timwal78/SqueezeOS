...
- **Still NO BACKTEST EVIDENCE for the composite as a whole** — this addition makes entries more selective, it does not constitute new profitability evidence. The "do not add `SML_SQUEEZE_FUEL` to `IAM_PRIMARY_SYSTEM`" rule above is unchanged.
