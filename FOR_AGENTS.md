...
curl https://squeezeos-api.onrender.com/api/demo
...
curl -X POST https://squeezeos-api.onrender.com/api/relay/register \
  -H "Content-Type: application/json" \
...
curl -X POST https://squeezeos-api.onrender.com/api/webhooks/subscribe \
  -H "Content-Type: application/json" \
  -d '{
...
| Service | URL |
|---------|-----|
| SqueezeOS (Render) | `https://squeezeos-api.onrender.com` |
